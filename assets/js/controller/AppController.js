import { HttpService } from "../utils/HttpService.js?v=20260610-public-tv-button";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-public-tv-button";
import { PublicController } from "./PublicController.js?v=20260610-public-tv-button";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-public-tv-button";
import { MainController } from "./MainController.js?v=20260610-public-tv-button";
import { LobbyController } from "./LobbyController.js?v=20260610-public-tv-button";
import { LobbyListController } from "./LobbyListController.js?v=20260610-public-tv-button";
import { GameController } from "./GameController.js?v=20260610-public-tv-button";
import { ResultController } from "./ResultController.js?v=20260610-public-tv-button";
import { TvController } from "./TvController.js?v=20260610-public-tv-button";
import { TvLinkController } from "./TvLinkController.js?v=20260610-public-tv-button";
import { ManagementController } from "./ManagementController.js?v=20260610-public-tv-button";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-public-tv-button";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-public-tv-button";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-public-tv-button";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-public-tv-button";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-public-tv-button";

const ASSET_VERSION = "20260610-public-tv-button";
