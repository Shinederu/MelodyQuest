import { HttpService } from "../utils/HttpService.js?v=20260609-mobile-ui";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-mobile-ui";
import { PublicController } from "./PublicController.js?v=20260609-mobile-ui";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-mobile-ui";
import { MainController } from "./MainController.js?v=20260609-mobile-ui";
import { LobbyController } from "./LobbyController.js?v=20260609-mobile-ui";
import { LobbyListController } from "./LobbyListController.js?v=20260609-mobile-ui";
import { GameController } from "./GameController.js?v=20260609-mobile-ui";
import { ResultController } from "./ResultController.js?v=20260609-mobile-ui";
import { TvController } from "./TvController.js?v=20260609-mobile-ui";
import { TvLinkController } from "./TvLinkController.js?v=20260609-mobile-ui";
import { ManagementController } from "./ManagementController.js?v=20260609-mobile-ui";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-mobile-ui";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-mobile-ui";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-mobile-ui";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-mobile-ui";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-mobile-ui";

const ASSET_VERSION = "20260609-mobile-ui";
