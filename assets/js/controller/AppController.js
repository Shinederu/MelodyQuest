import { HttpService } from "../utils/HttpService.js?v=20260611-tv-ready-preload";
import { HeaderModel } from "../model/HeaderModel.js?v=20260611-tv-ready-preload";
import { PublicController } from "./PublicController.js?v=20260611-tv-ready-preload";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260611-tv-ready-preload";
import { MainController } from "./MainController.js?v=20260611-tv-ready-preload";
import { LobbyController } from "./LobbyController.js?v=20260611-tv-ready-preload";
import { LobbyListController } from "./LobbyListController.js?v=20260611-tv-ready-preload";
import { GameController } from "./GameController.js?v=20260611-tv-ready-preload";
import { ResultController } from "./ResultController.js?v=20260611-tv-ready-preload";
import { TvController } from "./TvController.js?v=20260611-tv-ready-preload";
import { TvLinkController } from "./TvLinkController.js?v=20260611-tv-ready-preload";
import { ManagementController } from "./ManagementController.js?v=20260611-tv-ready-preload";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260611-tv-ready-preload";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260611-tv-ready-preload";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260611-tv-ready-preload";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260611-tv-ready-preload";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260611-tv-ready-preload";

const ASSET_VERSION = "20260611-tv-ready-preload";
