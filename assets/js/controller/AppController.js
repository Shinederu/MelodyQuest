import { HttpService } from "../utils/HttpService.js?v=20260609-tv-scan";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-tv-scan";
import { PublicController } from "./PublicController.js?v=20260609-tv-scan";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-tv-scan";
import { MainController } from "./MainController.js?v=20260609-tv-scan";
import { LobbyController } from "./LobbyController.js?v=20260609-tv-scan";
import { LobbyListController } from "./LobbyListController.js?v=20260609-tv-scan";
import { GameController } from "./GameController.js?v=20260609-tv-scan";
import { ResultController } from "./ResultController.js?v=20260609-tv-scan";
import { TvController } from "./TvController.js?v=20260609-tv-scan";
import { TvLinkController } from "./TvLinkController.js?v=20260609-tv-scan";
import { ManagementController } from "./ManagementController.js?v=20260609-tv-scan";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-tv-scan";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-tv-scan";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-tv-scan";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-tv-scan";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-tv-scan";

const ASSET_VERSION = "20260609-tv-scan";
