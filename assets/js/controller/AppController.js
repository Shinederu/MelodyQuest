import { HttpService } from "../utils/HttpService.js?v=20260609-tv-minimal";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-tv-minimal";
import { PublicController } from "./PublicController.js?v=20260609-tv-minimal";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-tv-minimal";
import { MainController } from "./MainController.js?v=20260609-tv-minimal";
import { LobbyController } from "./LobbyController.js?v=20260609-tv-minimal";
import { LobbyListController } from "./LobbyListController.js?v=20260609-tv-minimal";
import { GameController } from "./GameController.js?v=20260609-tv-minimal";
import { ResultController } from "./ResultController.js?v=20260609-tv-minimal";
import { TvController } from "./TvController.js?v=20260609-tv-minimal";
import { TvLinkController } from "./TvLinkController.js?v=20260609-tv-minimal";
import { ManagementController } from "./ManagementController.js?v=20260609-tv-minimal";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-tv-minimal";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-tv-minimal";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-tv-minimal";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-tv-minimal";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-tv-minimal";

const ASSET_VERSION = "20260609-tv-minimal";
