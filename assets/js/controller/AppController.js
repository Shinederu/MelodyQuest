import { HttpService } from "../utils/HttpService.js?v=20260613-tv-reveal-fix";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-tv-reveal-fix";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-tv-reveal-fix";
import { PublicController } from "./PublicController.js?v=20260613-tv-reveal-fix";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-tv-reveal-fix";
import { MainController } from "./MainController.js?v=20260613-tv-reveal-fix";
import { LobbyController } from "./LobbyController.js?v=20260613-tv-reveal-fix";
import { LobbyListController } from "./LobbyListController.js?v=20260613-tv-reveal-fix";
import { GameController } from "./GameController.js?v=20260613-tv-reveal-fix";
import { ResultController } from "./ResultController.js?v=20260613-tv-reveal-fix";
import { TvController } from "./TvController.js?v=20260613-tv-reveal-fix";
import { TvLinkController } from "./TvLinkController.js?v=20260613-tv-reveal-fix";
import { ManagementController } from "./ManagementController.js?v=20260613-tv-reveal-fix";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-tv-reveal-fix";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-tv-reveal-fix";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-tv-reveal-fix";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-tv-reveal-fix";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-tv-reveal-fix";

const ASSET_VERSION = "20260613-tv-reveal-fix";
