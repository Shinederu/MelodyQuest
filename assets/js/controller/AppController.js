import { HttpService } from "../utils/HttpService.js?v=20260610-tv-buffer-warmup";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-tv-buffer-warmup";
import { PublicController } from "./PublicController.js?v=20260610-tv-buffer-warmup";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-tv-buffer-warmup";
import { MainController } from "./MainController.js?v=20260610-tv-buffer-warmup";
import { LobbyController } from "./LobbyController.js?v=20260610-tv-buffer-warmup";
import { LobbyListController } from "./LobbyListController.js?v=20260610-tv-buffer-warmup";
import { GameController } from "./GameController.js?v=20260610-tv-buffer-warmup";
import { ResultController } from "./ResultController.js?v=20260610-tv-buffer-warmup";
import { TvController } from "./TvController.js?v=20260610-tv-buffer-warmup";
import { TvLinkController } from "./TvLinkController.js?v=20260610-tv-buffer-warmup";
import { ManagementController } from "./ManagementController.js?v=20260610-tv-buffer-warmup";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-tv-buffer-warmup";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-tv-buffer-warmup";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-tv-buffer-warmup";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-tv-buffer-warmup";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-tv-buffer-warmup";

const ASSET_VERSION = "20260610-tv-buffer-warmup";
