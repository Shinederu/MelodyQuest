import { HttpService } from "../utils/HttpService.js?v=20260610-round-number-modes";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-round-number-modes";
import { PublicController } from "./PublicController.js?v=20260610-round-number-modes";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-round-number-modes";
import { MainController } from "./MainController.js?v=20260610-round-number-modes";
import { LobbyController } from "./LobbyController.js?v=20260610-round-number-modes";
import { LobbyListController } from "./LobbyListController.js?v=20260610-round-number-modes";
import { GameController } from "./GameController.js?v=20260610-round-number-modes";
import { ResultController } from "./ResultController.js?v=20260610-round-number-modes";
import { TvController } from "./TvController.js?v=20260610-round-number-modes";
import { TvLinkController } from "./TvLinkController.js?v=20260610-round-number-modes";
import { ManagementController } from "./ManagementController.js?v=20260610-round-number-modes";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-round-number-modes";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-round-number-modes";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-round-number-modes";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-round-number-modes";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-round-number-modes";

const ASSET_VERSION = "20260610-round-number-modes";
