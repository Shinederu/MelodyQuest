import { HttpService } from "../utils/HttpService.js?v=20260610-shared-utils";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-shared-utils";
import { PublicController } from "./PublicController.js?v=20260610-shared-utils";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-shared-utils";
import { MainController } from "./MainController.js?v=20260610-shared-utils";
import { LobbyController } from "./LobbyController.js?v=20260610-shared-utils";
import { LobbyListController } from "./LobbyListController.js?v=20260610-shared-utils";
import { GameController } from "./GameController.js?v=20260610-shared-utils";
import { ResultController } from "./ResultController.js?v=20260610-shared-utils";
import { TvController } from "./TvController.js?v=20260610-shared-utils";
import { TvLinkController } from "./TvLinkController.js?v=20260610-shared-utils";
import { ManagementController } from "./ManagementController.js?v=20260610-shared-utils";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-shared-utils";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-shared-utils";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-shared-utils";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-shared-utils";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-shared-utils";

const ASSET_VERSION = "20260610-shared-utils";
