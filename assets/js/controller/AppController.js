import { HttpService } from "../utils/HttpService.js?v=20260610-tv-double-buffer";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-tv-double-buffer";
import { PublicController } from "./PublicController.js?v=20260610-tv-double-buffer";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-tv-double-buffer";
import { MainController } from "./MainController.js?v=20260610-tv-double-buffer";
import { LobbyController } from "./LobbyController.js?v=20260610-tv-double-buffer";
import { LobbyListController } from "./LobbyListController.js?v=20260610-tv-double-buffer";
import { GameController } from "./GameController.js?v=20260610-tv-double-buffer";
import { ResultController } from "./ResultController.js?v=20260610-tv-double-buffer";
import { TvController } from "./TvController.js?v=20260610-tv-double-buffer";
import { TvLinkController } from "./TvLinkController.js?v=20260610-tv-double-buffer";
import { ManagementController } from "./ManagementController.js?v=20260610-tv-double-buffer";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-tv-double-buffer";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-tv-double-buffer";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-tv-double-buffer";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-tv-double-buffer";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-tv-double-buffer";

const ASSET_VERSION = "20260610-tv-double-buffer";
