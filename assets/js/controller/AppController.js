import { HttpService } from "../utils/HttpService.js?v=20260613-player-clock-sync";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-player-clock-sync";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-player-clock-sync";
import { PublicController } from "./PublicController.js?v=20260613-player-clock-sync";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-player-clock-sync";
import { MainController } from "./MainController.js?v=20260613-player-clock-sync";
import { LobbyController } from "./LobbyController.js?v=20260613-player-clock-sync";
import { LobbyListController } from "./LobbyListController.js?v=20260613-player-clock-sync";
import { GameController } from "./GameController.js?v=20260613-player-clock-sync";
import { ResultController } from "./ResultController.js?v=20260613-player-clock-sync";
import { TvController } from "./TvController.js?v=20260613-player-clock-sync";
import { TvLinkController } from "./TvLinkController.js?v=20260613-player-clock-sync";
import { ManagementController } from "./ManagementController.js?v=20260613-player-clock-sync";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-player-clock-sync";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-player-clock-sync";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-player-clock-sync";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-player-clock-sync";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-player-clock-sync";

const ASSET_VERSION = "20260613-player-clock-sync";
