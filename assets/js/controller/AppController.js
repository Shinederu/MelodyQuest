import { HttpService } from "../utils/HttpService.js?v=20260613-player-sync-tight";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-player-sync-tight";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-player-sync-tight";
import { PublicController } from "./PublicController.js?v=20260613-player-sync-tight";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-player-sync-tight";
import { MainController } from "./MainController.js?v=20260613-player-sync-tight";
import { LobbyController } from "./LobbyController.js?v=20260613-player-sync-tight";
import { LobbyListController } from "./LobbyListController.js?v=20260613-player-sync-tight";
import { GameController } from "./GameController.js?v=20260613-player-sync-tight";
import { ResultController } from "./ResultController.js?v=20260613-player-sync-tight";
import { TvController } from "./TvController.js?v=20260613-player-sync-tight";
import { TvLinkController } from "./TvLinkController.js?v=20260613-player-sync-tight";
import { ManagementController } from "./ManagementController.js?v=20260613-player-sync-tight";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-player-sync-tight";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-player-sync-tight";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-player-sync-tight";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-player-sync-tight";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-player-sync-tight";

const ASSET_VERSION = "20260613-player-sync-tight";
