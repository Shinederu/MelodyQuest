import { HttpService } from "../utils/HttpService.js?v=20260609-player-mode";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-player-mode";
import { PublicController } from "./PublicController.js?v=20260609-player-mode";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-player-mode";
import { MainController } from "./MainController.js?v=20260609-player-mode";
import { LobbyController } from "./LobbyController.js?v=20260609-player-mode";
import { LobbyListController } from "./LobbyListController.js?v=20260609-player-mode";
import { GameController } from "./GameController.js?v=20260609-player-mode";
import { ResultController } from "./ResultController.js?v=20260609-player-mode";
import { TvController } from "./TvController.js?v=20260609-player-mode";
import { TvLinkController } from "./TvLinkController.js?v=20260609-player-mode";
import { ManagementController } from "./ManagementController.js?v=20260609-player-mode";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-player-mode";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-player-mode";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-player-mode";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-player-mode";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-player-mode";

const ASSET_VERSION = "20260609-player-mode";
