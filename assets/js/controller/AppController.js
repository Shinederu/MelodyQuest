import { HttpService } from "../utils/HttpService.js?v=20260609-round-preload";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-round-preload";
import { PublicController } from "./PublicController.js?v=20260609-round-preload";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-round-preload";
import { MainController } from "./MainController.js?v=20260609-round-preload";
import { LobbyController } from "./LobbyController.js?v=20260609-round-preload";
import { LobbyListController } from "./LobbyListController.js?v=20260609-round-preload";
import { GameController } from "./GameController.js?v=20260609-round-preload";
import { ResultController } from "./ResultController.js?v=20260609-round-preload";
import { TvController } from "./TvController.js?v=20260609-round-preload";
import { TvLinkController } from "./TvLinkController.js?v=20260609-round-preload";
import { ManagementController } from "./ManagementController.js?v=20260609-round-preload";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-round-preload";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-round-preload";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-round-preload";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-round-preload";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-round-preload";

const ASSET_VERSION = "20260609-round-preload";
