import { HttpService } from "../utils/HttpService.js?v=20260613-mobile-catchup";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-mobile-catchup";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-mobile-catchup";
import { PublicController } from "./PublicController.js?v=20260613-mobile-catchup";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-mobile-catchup";
import { MainController } from "./MainController.js?v=20260613-mobile-catchup";
import { LobbyController } from "./LobbyController.js?v=20260613-mobile-catchup";
import { LobbyListController } from "./LobbyListController.js?v=20260613-mobile-catchup";
import { GameController } from "./GameController.js?v=20260613-mobile-catchup";
import { ResultController } from "./ResultController.js?v=20260613-mobile-catchup";
import { TvController } from "./TvController.js?v=20260613-mobile-catchup";
import { TvLinkController } from "./TvLinkController.js?v=20260613-mobile-catchup";
import { ManagementController } from "./ManagementController.js?v=20260613-mobile-catchup";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-mobile-catchup";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-mobile-catchup";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-mobile-catchup";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-mobile-catchup";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-mobile-catchup";

const ASSET_VERSION = "20260613-mobile-catchup";
