import { HttpService } from "../utils/HttpService.js?v=20260610-tv-stable-player";
import { HeaderModel } from "../model/HeaderModel.js?v=20260610-tv-stable-player";
import { PublicController } from "./PublicController.js?v=20260610-tv-stable-player";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260610-tv-stable-player";
import { MainController } from "./MainController.js?v=20260610-tv-stable-player";
import { LobbyController } from "./LobbyController.js?v=20260610-tv-stable-player";
import { LobbyListController } from "./LobbyListController.js?v=20260610-tv-stable-player";
import { GameController } from "./GameController.js?v=20260610-tv-stable-player";
import { ResultController } from "./ResultController.js?v=20260610-tv-stable-player";
import { TvController } from "./TvController.js?v=20260610-tv-stable-player";
import { TvLinkController } from "./TvLinkController.js?v=20260610-tv-stable-player";
import { ManagementController } from "./ManagementController.js?v=20260610-tv-stable-player";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260610-tv-stable-player";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260610-tv-stable-player";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260610-tv-stable-player";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260610-tv-stable-player";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260610-tv-stable-player";

const ASSET_VERSION = "20260610-tv-stable-player";
