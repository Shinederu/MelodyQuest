import { HttpService } from "../utils/HttpService.js?v=20260613-tv-no-reveal-cue";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-tv-no-reveal-cue";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-tv-no-reveal-cue";
import { PublicController } from "./PublicController.js?v=20260613-tv-no-reveal-cue";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-tv-no-reveal-cue";
import { MainController } from "./MainController.js?v=20260613-tv-no-reveal-cue";
import { LobbyController } from "./LobbyController.js?v=20260613-tv-no-reveal-cue";
import { LobbyListController } from "./LobbyListController.js?v=20260613-tv-no-reveal-cue";
import { GameController } from "./GameController.js?v=20260613-tv-no-reveal-cue";
import { ResultController } from "./ResultController.js?v=20260613-tv-no-reveal-cue";
import { TvController } from "./TvController.js?v=20260613-tv-no-reveal-cue";
import { TvLinkController } from "./TvLinkController.js?v=20260613-tv-no-reveal-cue";
import { ManagementController } from "./ManagementController.js?v=20260613-tv-no-reveal-cue";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-tv-no-reveal-cue";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-tv-no-reveal-cue";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-tv-no-reveal-cue";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-tv-no-reveal-cue";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-tv-no-reveal-cue";

const ASSET_VERSION = "20260613-tv-no-reveal-cue";
