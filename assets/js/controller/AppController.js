import { HttpService } from "../utils/HttpService.js?v=20260613-tv-preload-loop";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-tv-preload-loop";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-tv-preload-loop";
import { PublicController } from "./PublicController.js?v=20260613-tv-preload-loop";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-tv-preload-loop";
import { MainController } from "./MainController.js?v=20260613-tv-preload-loop";
import { LobbyController } from "./LobbyController.js?v=20260613-tv-preload-loop";
import { LobbyListController } from "./LobbyListController.js?v=20260613-tv-preload-loop";
import { GameController } from "./GameController.js?v=20260613-tv-preload-loop";
import { ResultController } from "./ResultController.js?v=20260613-tv-preload-loop";
import { TvController } from "./TvController.js?v=20260613-tv-preload-loop";
import { TvLinkController } from "./TvLinkController.js?v=20260613-tv-preload-loop";
import { ManagementController } from "./ManagementController.js?v=20260613-tv-preload-loop";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-tv-preload-loop";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-tv-preload-loop";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-tv-preload-loop";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-tv-preload-loop";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-tv-preload-loop";

const ASSET_VERSION = "20260613-tv-preload-loop";
