import { HttpService } from "../utils/HttpService.js?v=20260609-mobile-ui-v2";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-mobile-ui-v2";
import { PublicController } from "./PublicController.js?v=20260609-mobile-ui-v2";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-mobile-ui-v2";
import { MainController } from "./MainController.js?v=20260609-mobile-ui-v2";
import { LobbyController } from "./LobbyController.js?v=20260609-mobile-ui-v2";
import { LobbyListController } from "./LobbyListController.js?v=20260609-mobile-ui-v2";
import { GameController } from "./GameController.js?v=20260609-mobile-ui-v2";
import { ResultController } from "./ResultController.js?v=20260609-mobile-ui-v2";
import { TvController } from "./TvController.js?v=20260609-mobile-ui-v2";
import { TvLinkController } from "./TvLinkController.js?v=20260609-mobile-ui-v2";
import { ManagementController } from "./ManagementController.js?v=20260609-mobile-ui-v2";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-mobile-ui-v2";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-mobile-ui-v2";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-mobile-ui-v2";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-mobile-ui-v2";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-mobile-ui-v2";

const ASSET_VERSION = "20260609-mobile-ui-v2";
