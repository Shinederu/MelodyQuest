import { HttpService } from "../utils/HttpService.js?v=20260609-responsive-safe";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-responsive-safe";
import { PublicController } from "./PublicController.js?v=20260609-responsive-safe";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-responsive-safe";
import { MainController } from "./MainController.js?v=20260609-responsive-safe";
import { LobbyController } from "./LobbyController.js?v=20260609-responsive-safe";
import { LobbyListController } from "./LobbyListController.js?v=20260609-responsive-safe";
import { GameController } from "./GameController.js?v=20260609-responsive-safe";
import { ResultController } from "./ResultController.js?v=20260609-responsive-safe";
import { TvController } from "./TvController.js?v=20260609-responsive-safe";
import { TvLinkController } from "./TvLinkController.js?v=20260609-responsive-safe";
import { ManagementController } from "./ManagementController.js?v=20260609-responsive-safe";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-responsive-safe";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-responsive-safe";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-responsive-safe";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-responsive-safe";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-responsive-safe";

const ASSET_VERSION = "20260609-responsive-safe";
