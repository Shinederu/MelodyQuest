import { HttpService } from "../utils/HttpService.js?v=20260609-tv-fit";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-tv-fit";
import { PublicController } from "./PublicController.js?v=20260609-tv-fit";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-tv-fit";
import { MainController } from "./MainController.js?v=20260609-tv-fit";
import { LobbyController } from "./LobbyController.js?v=20260609-tv-fit";
import { LobbyListController } from "./LobbyListController.js?v=20260609-tv-fit";
import { GameController } from "./GameController.js?v=20260609-tv-fit";
import { ResultController } from "./ResultController.js?v=20260609-tv-fit";
import { TvController } from "./TvController.js?v=20260609-tv-fit";
import { TvLinkController } from "./TvLinkController.js?v=20260609-tv-fit";
import { ManagementController } from "./ManagementController.js?v=20260609-tv-fit";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-tv-fit";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-tv-fit";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-tv-fit";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-tv-fit";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-tv-fit";

const ASSET_VERSION = "20260609-tv-fit";
