import { HttpService } from "../utils/HttpService.js?v=20260613-resync-lead";
import { HeaderModel } from "../model/HeaderModel.js?v=20260613-resync-lead";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260613-resync-lead";
import { PublicController } from "./PublicController.js?v=20260613-resync-lead";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260613-resync-lead";
import { MainController } from "./MainController.js?v=20260613-resync-lead";
import { LobbyController } from "./LobbyController.js?v=20260613-resync-lead";
import { LobbyListController } from "./LobbyListController.js?v=20260613-resync-lead";
import { GameController } from "./GameController.js?v=20260613-resync-lead";
import { ResultController } from "./ResultController.js?v=20260613-resync-lead";
import { TvController } from "./TvController.js?v=20260613-resync-lead";
import { TvLinkController } from "./TvLinkController.js?v=20260613-resync-lead";
import { ManagementController } from "./ManagementController.js?v=20260613-resync-lead";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260613-resync-lead";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260613-resync-lead";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260613-resync-lead";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260613-resync-lead";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260613-resync-lead";

const ASSET_VERSION = "20260613-resync-lead";
