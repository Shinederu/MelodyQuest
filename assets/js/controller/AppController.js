import { HttpService } from "../utils/HttpService.js?v=20260609-tv-sync";
import { HeaderModel } from "../model/HeaderModel.js?v=20260609-tv-sync";
import { PublicController } from "./PublicController.js?v=20260609-tv-sync";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260609-tv-sync";
import { MainController } from "./MainController.js?v=20260609-tv-sync";
import { LobbyController } from "./LobbyController.js?v=20260609-tv-sync";
import { LobbyListController } from "./LobbyListController.js?v=20260609-tv-sync";
import { GameController } from "./GameController.js?v=20260609-tv-sync";
import { ResultController } from "./ResultController.js?v=20260609-tv-sync";
import { TvController } from "./TvController.js?v=20260609-tv-sync";
import { TvLinkController } from "./TvLinkController.js?v=20260609-tv-sync";
import { ManagementController } from "./ManagementController.js?v=20260609-tv-sync";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260609-tv-sync";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260609-tv-sync";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260609-tv-sync";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260609-tv-sync";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260609-tv-sync";

const ASSET_VERSION = "20260609-tv-sync";
