import { HttpService } from "../utils/HttpService.js?v=20260612-tv-player-hotfix";
import { HeaderModel } from "../model/HeaderModel.js?v=20260612-tv-player-hotfix";
import { PublicController } from "./PublicController.js?v=20260612-tv-player-hotfix";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260612-tv-player-hotfix";
import { MainController } from "./MainController.js?v=20260612-tv-player-hotfix";
import { LobbyController } from "./LobbyController.js?v=20260612-tv-player-hotfix";
import { LobbyListController } from "./LobbyListController.js?v=20260612-tv-player-hotfix";
import { GameController } from "./GameController.js?v=20260612-tv-player-hotfix";
import { ResultController } from "./ResultController.js?v=20260612-tv-player-hotfix";
import { TvController } from "./TvController.js?v=20260612-tv-player-hotfix";
import { TvLinkController } from "./TvLinkController.js?v=20260612-tv-player-hotfix";
import { ManagementController } from "./ManagementController.js?v=20260612-tv-player-hotfix";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260612-tv-player-hotfix";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260612-tv-player-hotfix";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260612-tv-player-hotfix";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260612-tv-player-hotfix";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260612-tv-player-hotfix";

const ASSET_VERSION = "20260612-tv-player-hotfix";
