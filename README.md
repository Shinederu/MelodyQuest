...
- cache-bust JS courant: `20260613-backend-late-sync`;
...
- smoke test `/tv`: QR affiche, script `20260613-backend-late-sync`, CSS `20260613-tv-hidden-video`, aucun conteneur `tv-video-preload-player`, aucune erreur console.
