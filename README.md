...
- cache-bust JS courant: `20260613-mobile-catchup`;
...
- smoke test `/tv`: QR affiche, script `20260613-mobile-catchup`, CSS `20260613-tv-hidden-video`, aucun conteneur `tv-video-preload-player`, aucune erreur console.
