...
- cache-bust JS courant: `20260613-tv-reveal-fix`;
...
- smoke test `/tv`: QR affiche, script `20260613-tv-reveal-fix`, CSS `20260613-tv-hidden-video`, aucun conteneur `tv-video-preload-player`, aucune erreur console.
